...
namespace PlannerCalendarClient.ExchangeServiceCreator
{
    ...
    public static class CertificateCallback
    {
             ...
             System.Net.Security.SslPolicyErrors sslPolicyErrors)
        {
            ...
            {
                Logger.LogDebug(LoggingEvents.DebugEvent.CertificateValidationCallBackSucceed("SslPolicyErrors.None - issure: '" + issure +"'"));
                return true;
            }

            if (certificate != null)
            {
                Logger.LogDebug(LoggingEvents.DebugEvent.CertificateValidationCallBackSucceed("Certificate != null - issure: '" + issure + "'"));
                return true;
            }
            ...
            Logger.LogDebug(LoggingEvents.DebugEvent.CertificateValidationCallBackFailed(issure));
            throw new CertificateValidationException(issure);
        }
    }
}
